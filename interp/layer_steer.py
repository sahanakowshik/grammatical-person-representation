...
for coeff in coeff_values:
    ...
    pd.DataFrame(pos_steering_result).to_csv(f'./steer_results/layer_steering/{folder_name}_coeff_{coeff}_pos_steer.csv')
    pd.DataFrame(neg_steering_result).to_csv(f'./steer_results/layer_steering/{folder_name}_coeff_{coeff}_neg_steer.csv')