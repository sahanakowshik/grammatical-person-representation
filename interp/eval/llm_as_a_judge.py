...
# save_name = "llm_as_a_judge_results/llama/pos/run_5.jsonl"
...
save_name = "llm_as_a_judge_results/llama/neg/run_5.jsonl"


# LLM_prompt = """You will be given an LLM response. Output [yes] if the LLM responds as an assistant helping a user and output [no] if the LLM responds from its own persona. If the response is not coherent, output [Not coherent].

# Prompt given to the LLM: {prompt}, language model response: {response}"""
